...
4. Follow to set up boost client and upload data to Google Sheet via Google API.
5. For online firmware updates, please refer to [OTA](https://github.com/hungdaqq/Temperature-Wireless-Sensor-Network/tree/main/OTA) for sensor nodes over-the-air firmware updating instrucion, [painlessmeshboost](https://github.com/hungdaqq/Temperature-Wireless-Sensor-Network/tree/main/painlessmeshboost) for setting up boost client.
